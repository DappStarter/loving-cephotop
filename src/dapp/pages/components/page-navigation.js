...
export default class PageNavigation extends CustomElement {
    ...
    getPages() {
        ...
        return staticPages.concat([{"name":"token","title":"Custom Token","description":"Create a token for tracking value associated with your dapp.","category":"Asset and Value Tracking","route":"/token"},{"name":"sia","title":"Sia Documents","description":"Sia decentralized file storage","category":"File Storage","route":"/sia"}]); 
    }
